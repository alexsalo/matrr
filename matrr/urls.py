...
#        display_cohorts),
    ...
    url(r'^cohort/(?P<cohort_id>\d+)/monkey/(?P<monkey_id>\d+)/$',
        monkey_cohort_detail_view, name='monkey_detail_coh'),
    url(r'^available/(?P<cohort_id>\d+)/monkey/(?P<monkey_id>\d+)/$',
        monkey_cohort_detail_view, name='monkey_detail_av'),
    url(r'^upcoming/(?P<cohort_id>\d+)/monkey/(?P<monkey_id>\d+)/$',
        monkey_cohort_detail_view, name='monkey_detail_up'),
