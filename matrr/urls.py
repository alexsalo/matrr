...
urlpatterns += patterns('matrr.views',
  ...
  url( r'^(available|upcoming|cohort)/(?P<pk>\d+)/tissues/$',
  ...
  url( r'^monkeys/(?P<monkey_id>\S+)/$',
      monkey_detail_view),
  url( r'^(available|upcoming|cohort)/(?P<cohort_id>\d+)/tissues/(?P<tissue_model>regions|peripherals)/$',
      tissue_list),
  url( r'^(available|upcoming|cohort)/(?P<cohort_id>\d+)/tissues/(?P<tissue_model>regions|peripherals)/(?P<tissue_id>\d+)/$',
      tissue_shop_detail_view),
  url( r'^(available|upcoming|cohort)/(?P<cohort_id>\d+)/tissues/custom/$',
      tissue_shop_custom_detail_view),
  url( r'^cart/(?P<tissue_model>regions|peripherals|custom)/(?P<tissue_request_id>\d+)/$',
    cart_item_view),
  url( r'^cart/(?P<tissue_model>regions|peripherals|custom)/(?P<tissue_request_id>\d+)/delete/$',
      cart_item_delete),
