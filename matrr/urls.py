...
from matrr.models import Cohort, Event
...
urlpatterns = patterns('',
                       ...
                       url(r'^archived-events/$', display.archived_event_list, name='archieved-events'),
...
urlpatterns += patterns('',
                        ...
                        url(r'^mta/list/$', basic.mta_list, name='mta-list'),
                        ...
                        url(r'^cohort/(?P<coh_id>\d+)/monkey/(?P<mky_id>\d+)/$', display.monkey_cohort_detail_view,
                            name='monkey-detail'),
                        url(r'^monkey/(?P<mky_id>\d+)/$', display.monkey_detail_view, name='monkey-detail'),
                        url(r'^cohort/(?P<coh_id>\d+)/tissues/(?P<tissue_category>[^/]*)/$', display.tissue_list,
                        ...
                        url(r'^cohort/(?P<coh_id>\d+)/tissues/add-to-cart/(?P<tissue_id>\d+)/$',
                            display.tissue_shop_detail_view, name='tissue-shop-detail'),
                        ##  Cart Views
                        ...
                        url(r'^orders/(?P<req_request_id>\d+)/revise/confirm/$', orders.order_revise_confirm,
                            name='order-revise-confirm'),
                        url(r'^orders/(?P<req_request_id>\d+)/duplicate/$', orders.order_duplicate, name='order-duplicate'),
                        url(r'^orders/(?P<req_request_id>\d+)/duplicate/confirm/$', orders.order_duplicate_confirm,
                        ...
                        url(r'^orders/delete-tissue/(?P<req_rtt_id>\d+)/$', orders.order_delete_tissue,
                        ...
                        url(r'^reviews_overviews/(?P<req_request_id>\d+)/price/$', review.review_overview_price,
                            name='review-overview-price'),
                        url(r'^reviews_overviews/(?P<req_request_id>\d+)/process/?$', review.request_review_process,
                        ...
                        url(r'^shipping/history/(?P<user_id>\d+)/$', shipping.shipping_history_user,
                        ...
                        url(r'^shipping/detail/(?P<shipment_id>\d+)/manifest/$', shipping.shipment_manifest_export,
                        ...
                        url(r'^verification/(?P<req_request_id>\d+)/$', verification.tissue_verification_list,
                            name='verification-list'),
                        url(r'^verification/(?P<req_request_id>\d+)/export$', verification.tissue_verification_export,
                            name='verification-list-export'),
                        url(r'^verification/(?P<req_request_id>\d+)/(?P<tiv_id>\d+)/$', verification.tissue_verification_detail,
                        ...
                        url(r'^tools/confederates/chord$', tools.tools_confederates_chord_diagram,
                            name='tools-confederates-chord'),
                        url(r'^tools/confederates/adjacency$', tools.tools_confederates_adjacency_matrix,
                            name='tools-confederates-adjacency'),
                        # Proteins
                        url(r'^tools/protein/$', tools.tools_protein, name='tools-protein'),
                        url(r'^tools/protein/cohort/(?P<coh_id>\d+)/$', tools.tools_cohort_protein,
                            name='tools-cohort-protein'),
                        url(r'^tools/protein/cohort/(?P<coh_id>\d+)/graphs$', tools.tools_cohort_protein_graphs,
                            name='tools-cohort-protein-graphs'),
                        url(r'^tools/protein/cohort/(?P<coh_id>\d+)/monkey/$', tools.tools_monkey_protein_graphs,
                            name='tools-monkey-protein'),
                        url(r'^tools/protein/cohort/(?P<coh_id>\d+)/monkey/(?P<mky_id>\d+)/$',
                            tools.tools_monkey_protein_graphs, name='tools-monkey-protein'),
                        # Hormones
                        url(r'^tools/hormone/$', tools.tools_hormone, name='tools-hormone'),
                        url(r'^tools/hormone/cohort/(?P<coh_id>\d+)/$', tools.tools_cohort_hormone,
                            name='tools-cohort-hormone'),
                        url(r'^tools/hormone/cohort/(?P<coh_id>\d+)/graphs$', tools.tools_cohort_hormone_graphs,
                            name='tools-cohort-hormone-graphs'),
                        url(r'^tools/hormone/cohort/(?P<coh_id>\d+)/monkey/$', tools.tools_monkey_hormone_graphs,
                            name='tools-monkey-hormone'),
                        url(r'^tools/hormone/cohort/(?P<coh_id>\d+)/monkey/(?P<mky_id>\d+)/$',
                            tools.tools_monkey_hormone_graphs, name='tools-monkey-hormone'),
                        # ETOH
                        url(r'^tools/etoh/cohort/(?P<cohort_method>[a-zA-Z_]+)/$', tools.tools_cohort_etoh_graphs,
                            name='tools-cohort-etoh-graphs'),
                        url(r'^tools/etoh/monkey/(?P<monkey_method>[a-zA-Z_]+)/$', tools.tools_monkey_etoh,
                            name='tools-monkey-etoh'),
                        url(r'^tools/etoh/monkey/(?P<monkey_method>[a-zA-Z_]+)/(?P<coh_id>\d+)/$',
                            tools.tools_monkey_etoh_graphs, name='tools-monkey-etoh-graphs'),
                        url(r'^tools/etoh/mtd-graph/(?P<mtd_id>\d+)$', tools.tools_etoh_mtd, name='tools-etoh-mtd'),
                        # BEC
                        url(r'^tools/bec/cohort/(?P<cohort_method>.+)/$', tools.tools_cohort_bec_graphs,
                            name='tools-cohort-bec-graphs'),
                        url(r'^tools/bec/monkey/(?P<monkey_method>[a-zA-Z_]+)/$', tools.tools_monkey_bec,
                            name='tools-monkey-bec'),
                        url(r'^tools/bec/monkey/(?P<monkey_method>[a-zA-Z_]+)/(?P<coh_id>\d+)/$',
                            tools.tools_monkey_bec_graphs, name='tools-monkey-bec-graphs'),
                        # genealogy
