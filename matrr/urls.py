...
urlpatterns += patterns('matrr.views',
	...
	url(r'^orders/(?P<req_request_id>\d+)/revise/confirm/$',	order_revise_confirm, name='order-revise-confirm'),
	url(r'^orders/(?P<req_request_id>\d+)/duplicate/$', 		order_duplicate, name='order-duplicate'),
	url(r'^orders/(?P<req_request_id>\d+)/duplicate/confirm/$', order_duplicate_confirm, name='order-duplicate-confirm'),
	...
	## Inventory views
	url(r'^inventory/$', user_passes_test(lambda u: u.has_perm('matrr.browse_inventory'), login_url='/denied/')(
                ListView.as_view(model=Cohort, template_name="matrr/inventory/inventory.html")), name='inventory'),
	...
	url(r'^tools/hormone/cohort/(?P<coh_id>\d+)/$', tools_cohort_hormone, name='tools-cohort-hormone'),
	url(r'^tools/hormone/cohort/(?P<coh_id>\d+)/graphs$', tools_cohort_hormone_graphs, name='tools-cohort-hormone-graphs'),
	url(r'^tools/hormone/cohort/(?P<coh_id>\d+)/monkey/$', tools_monkey_hormone_graphs, name='tools-monkey-hormone'),
	url(r'^tools/hormone/cohort/(?P<coh_id>\d+)/monkey/(?P<mky_id>\d+)/$', tools_monkey_hormone_graphs, name='tools-monkey-hormone'),
    # ETOH
