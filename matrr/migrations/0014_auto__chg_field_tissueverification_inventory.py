...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TissueVerification.inventory'
        db.alter_column('tvm_tissue_verification', 'inv_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['matrr.InventoryStatus'], db_column='inv_id'))


    def backwards(self, orm):
        
        # Changing field 'TissueVerification.inventory'
        db.alter_column('tvm_tissue_verification', 'inv_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matrr.InventoryStatus'], null=True, db_column='inv_id'))
