...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TissueRequestReview.vtr_quantity'
        db.alter_column('vtr_reviews_to_tissue_requests', 'vtr_quantity', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))


    def backwards(self, orm):
        
        # Changing field 'TissueRequestReview.vtr_quantity'
        db.alter_column('vtr_reviews_to_tissue_requests', 'vtr_quantity', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
