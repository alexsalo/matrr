...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tss_tissue_samples', 'units', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['matrr.Unit']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TissueSample.tss_sample_units'
        raise RuntimeError("Cannot reverse this migration. 'TissueSample.tss_sample_units' and its values cannot be restored.")
