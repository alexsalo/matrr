...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('act_account', 'address')

        # Deleting field 'Account.phone_number'
        db.delete_column('act_account', 'phone_number')

        # Deleting field 'Account.institution'
        db.delete_column('act_account', 'institution')
