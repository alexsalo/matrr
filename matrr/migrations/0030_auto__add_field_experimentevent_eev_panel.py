...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExperimentEvent.eev_panel'
        db.add_column('eev_experiment_events', 'eev_panel', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExperimentEvent.eev_panel'
        db.delete_column('eev_experiment_events', 'eev_panel')
