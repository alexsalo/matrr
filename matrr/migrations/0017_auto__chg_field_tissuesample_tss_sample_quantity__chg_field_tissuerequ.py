...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TissueSample.tss_sample_quantity'
        db.alter_column('tss_tissue_samples', 'tss_sample_quantity', self.gf('django.db.models.fields.FloatField')(null=True))
        ...
        # Adding field 'Request.req_safety_agreement'
        db.add_column('req_requests', 'req_safety_agreement', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TissueSample.tss_sample_quantity'
        db.alter_column('tss_tissue_samples', 'tss_sample_quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5))
        ...
        # Deleting field 'Request.req_safety_agreement'
        db.delete_column('req_requests', 'req_safety_agreement')
