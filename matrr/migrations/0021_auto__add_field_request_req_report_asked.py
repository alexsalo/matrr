...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Request.req_report_asked'
        db.add_column('req_requests', 'req_report_asked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Request.req_report_asked'
        db.delete_column('req_requests', 'req_report_asked')
