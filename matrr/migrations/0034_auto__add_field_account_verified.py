...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.verified'
        db.add_column('act_account', 'verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.verified'
        db.delete_column('act_account', 'verified')
    ...
    models = {
        ...
        'matrr.account': {
            ...
            'institution': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
