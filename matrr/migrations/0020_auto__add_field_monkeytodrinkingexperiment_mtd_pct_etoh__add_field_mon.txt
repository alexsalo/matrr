...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MonkeyToDrinkingExperiment.mtd_pct_etoh'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_etoh', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_g_kg'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_g_kg', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_drink_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_drink_bout', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_veh_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_bout', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_veh_drink_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_drink_bout', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_conc'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_conc', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_mean_drink_length'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_mean_drink_length', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_median_idi'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_median_idi', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_mean_drink_vol'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_mean_drink_vol', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_mean_bout_length'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_mean_bout_length', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_media_ibi'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_media_ibi', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_mean_bout_vol'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_mean_bout_vol', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_st_1'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_st_1', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_st_2'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_st_2', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_st_3'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_st_3', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_veh_st_2'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_st_2', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_veh_st_3'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_st_3', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_pellets_st_1'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_pellets_st_1', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_pellets_st_3'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_pellets_st_3', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_length_st_1'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_length_st_1', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_length_st_2'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_length_st_2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_length_st_3'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_length_st_3', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_vol_1st_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_vol_1st_bout', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_pct_etoh_in_1st_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_etoh_in_1st_bout', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_drinks_1st_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_drinks_1st_bout', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_mean_drink_vol_1st_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_mean_drink_vol_1st_bout', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_fi_wo_drinking_st_1'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_fi_wo_drinking_st_1', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_pct_fi_with_drinking_st_1'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_fi_with_drinking_st_1', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_latency_1st_drink'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_latency_1st_drink', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_pct_exp_etoh'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_exp_etoh', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_st_1_ioc_avg'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_st_1_ioc_avg', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_max_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_max_bout_start'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout_start', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_max_bout_end'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout_end', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_max_bout_length'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout_length', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_max_bout_vol'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout_vol', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MonkeyToDrinkingExperiment.mtd_pct_max_bout_vol_total_etoh'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_max_bout_vol_total_etoh', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MonkeyToDrinkingExperiment.mtd_pct_etoh'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_etoh')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_g_kg'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_g_kg')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_drink_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_drink_bout')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_veh_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_bout')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_veh_drink_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_drink_bout')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_conc'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_conc')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_mean_drink_length'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_mean_drink_length')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_median_idi'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_median_idi')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_mean_drink_vol'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_mean_drink_vol')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_mean_bout_length'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_mean_bout_length')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_media_ibi'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_media_ibi')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_mean_bout_vol'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_mean_bout_vol')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_st_1'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_st_1')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_st_2'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_st_2')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_st_3'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_st_3')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_veh_st_2'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_st_2')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_veh_st_3'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_st_3')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_pellets_st_1'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_pellets_st_1')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_pellets_st_3'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_pellets_st_3')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_length_st_1'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_length_st_1')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_length_st_2'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_length_st_2')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_length_st_3'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_length_st_3')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_vol_1st_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_vol_1st_bout')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_pct_etoh_in_1st_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_etoh_in_1st_bout')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_drinks_1st_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_drinks_1st_bout')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_mean_drink_vol_1st_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_mean_drink_vol_1st_bout')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_fi_wo_drinking_st_1'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_fi_wo_drinking_st_1')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_pct_fi_with_drinking_st_1'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_fi_with_drinking_st_1')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_latency_1st_drink'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_latency_1st_drink')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_pct_exp_etoh'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_exp_etoh')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_st_1_ioc_avg'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_st_1_ioc_avg')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_max_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_max_bout_start'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout_start')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_max_bout_end'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout_end')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_max_bout_length'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout_length')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_max_bout_vol'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_max_bout_vol')

        # Deleting field 'MonkeyToDrinkingExperiment.mtd_pct_max_bout_vol_total_etoh'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_pct_max_bout_vol_total_etoh')
    ...
    models = {
        ...
        'matrr.inventorystatus': {
            'Meta': {'object_name': 'InventoryStatus', 'db_table': "'inv_inventory_status'"},
            'inv_description': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'inv_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inv_status': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'})
        },
        'matrr.monkey': {
        ...
        'matrr.tissueinventoryverification': {
            ...
            'inventory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['matrr.InventoryStatus']", 'db_column': "'inv_id'"}),
        ...
        'matrr.tissuesample': {
            ...
            'tss_sample_quantity': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True'}),
