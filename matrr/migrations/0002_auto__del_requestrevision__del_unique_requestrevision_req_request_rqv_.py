...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field accepted_monkeys on 'TissueRequest'
        db.create_table('atr_accepted_monkeys_to_tissue_requests', (
        ...
        db.create_unique('atr_accepted_monkeys_to_tissue_requests', ['tissuerequest_id', 'monkey_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field accepted_monkeys on 'TissueRequest'
        db.delete_table('atr_accepted_monkeys_to_tissue_requests')
