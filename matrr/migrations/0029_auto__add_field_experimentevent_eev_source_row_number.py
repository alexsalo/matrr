...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExperimentEvent.eev_source_row_number'
        db.add_column('eev_experiment_events', 'eev_source_row_number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExperimentEvent.eev_source_row_number'
        db.delete_column('eev_experiment_events', 'eev_source_row_number')
