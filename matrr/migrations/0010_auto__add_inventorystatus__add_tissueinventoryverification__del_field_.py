...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('inv_inventory_status', (
            ('inv_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inv_status', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('inv_description', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('matrr', ['InventoryStatus'])

        # Adding model 'TissueInventoryVerification'
        db.create_table('tiv_tissue_verification', (
            ('tiv_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tissue_request', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tissue_verification_set', null=True, db_column='rtt_tissue_request_id', to=orm['matrr.TissueRequest'])),
            ('tissue_sample', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tissue_verification_set', null=True, db_column='tss_id', to=orm['matrr.TissueSample'])),
            ('tissue_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tissue_verification_set', db_column='tst_type_id', to=orm['matrr.TissueType'])),
            ('monkey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tissue_verification_set', db_column='mky_id', to=orm['matrr.Monkey'])),
            ('inventory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matrr.InventoryStatus'], db_column='inv_id')),
            ('tiv_notes', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('tiv_date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('tiv_date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('matrr', ['TissueInventoryVerification'])

        # Deleting field 'TissueSample.tss_distributed_count'
        db.delete_column('tss_tissue_samples', 'tss_distributed_count')

        # Deleting field 'TissueSample.tss_sample_count'
        db.delete_column('tss_tissue_samples', 'tss_sample_count')

        # Adding field 'TissueSample.tss_sample_quantity'
        db.add_column('tss_tissue_samples', 'tss_sample_quantity', self.gf('django.db.models.fields.DecimalField')(default=-1, max_digits=10, decimal_places=5), keep_default=False)

        # Adding field 'TissueSample.units'
        db.add_column('tss_tissue_samples', 'units', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['matrr.Unit']), keep_default=False)

        # Changing field 'TissueRequest.rtt_amount'
        db.alter_column('rtt_requests_to_tissue_types', 'rtt_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5))

        # Changing field 'Monkey.mky_weight'
        db.alter_column('mky_monkeys', 'mky_weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5))

        # Changing field 'MonkeyToDrinkingExperiment.mtd_weight'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5))

        # Changing field 'MonkeyToDrinkingExperiment.mtd_veh_intake'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_intake', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5))

        # Changing field 'MonkeyToDrinkingExperiment.mtd_etoh_intake'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_intake', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5))

        # Changing field 'TissueType.tst_cost'
        db.alter_column('tst_tissue_types', 'tst_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))


    def backwards(self, orm):
        
        # Deleting model 'InventoryStatus'
        db.delete_table('inv_inventory_status')

        # Deleting model 'TissueInventoryVerification'
        db.delete_table('tiv_tissue_verification')

        # Adding field 'TissueSample.tss_distributed_count'
        db.add_column('tss_tissue_samples', 'tss_distributed_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'TissueSample.tss_sample_count'
        raise RuntimeError("Cannot reverse this migration. 'TissueSample.tss_sample_count' and its values cannot be restored.")

        # Deleting field 'TissueSample.tss_sample_quantity'
        db.delete_column('tss_tissue_samples', 'tss_sample_quantity')

        # Deleting field 'TissueSample.units'
        db.delete_column('tss_tissue_samples', 'units_id')

        # Changing field 'TissueRequest.rtt_amount'
        db.alter_column('rtt_requests_to_tissue_types', 'rtt_amount', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Monkey.mky_weight'
        db.alter_column('mky_monkeys', 'mky_weight', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'MonkeyToDrinkingExperiment.mtd_weight'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_weight', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'MonkeyToDrinkingExperiment.mtd_veh_intake'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_intake', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'MonkeyToDrinkingExperiment.mtd_etoh_intake'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_intake', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'TissueType.tst_cost'
        db.alter_column('tst_tissue_types', 'tst_cost', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'matrr.monkey': {
            ...
            'mky_weight': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'})
        },
        'matrr.monkeytodrinkingexperiment': {
            ...
            'mtd_etoh_intake': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'}),
            ...
            'mtd_veh_intake': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'}),
            'mtd_weight': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'})
        },
        'matrr.mta': {
        ...
        'matrr.tissuerequest': {
            ...
            'rtt_amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '5'}),
        ...
        'matrr.tissuesample': {
            ...
            'tss_sample_quantity': ('django.db.models.fields.DecimalField', [], {'default': '-1', 'max_digits': '10', 'decimal_places': '5'}),
        ...
        'matrr.tissuetype': {
            ...
            'tst_cost': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '10', 'decimal_places': '2'}),
