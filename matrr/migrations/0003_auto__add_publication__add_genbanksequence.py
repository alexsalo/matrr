...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pub_publications', (
            ...
            ('journal', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('published_year', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('published_month', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('issue', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ...
            ('pmcid', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('isbn', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('abstract', self.gf('django.db.models.fields.TextField')(null=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('matrr', ['Publication'])

        # Adding M2M table for field cohorts on 'Publication'
        db.create_table('ptc_publications_to_cohorts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('publication', models.ForeignKey(orm['matrr.publication'], null=False)),
            ('cohort', models.ForeignKey(orm['matrr.cohort'], null=False))
        ))
        db.create_unique('ptc_publications_to_cohorts', ['publication_id', 'cohort_id'])

        # Adding model 'GenBankSequence'
        db.create_table('gen_genbank_sequences', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('accession', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('matrr', ['GenBankSequence'])

        # Adding M2M table for field cohort on 'GenBankSequence'
        db.create_table('gtc_genbank_to_cohorts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('genbanksequence', models.ForeignKey(orm['matrr.genbanksequence'], null=False)),
            ('cohort', models.ForeignKey(orm['matrr.cohort'], null=False))
        ))
        db.create_unique('gtc_genbank_to_cohorts', ['genbanksequence_id', 'cohort_id'])


    def backwards(self, orm):
        
        # Deleting model 'Publication'
        db.delete_table('pub_publications')

        # Removing M2M table for field cohorts on 'Publication'
        db.delete_table('ptc_publications_to_cohorts')

        # Deleting model 'GenBankSequence'
        db.delete_table('gen_genbank_sequences')

        # Removing M2M table for field cohort on 'GenBankSequence'
        db.delete_table('gtc_genbank_to_cohorts')
    ...
    models = {
        ...
        'matrr.bloodandgeneticrequest': {
            ...
            'accepted_monkeys': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'accepted_blood_genetic_request_set'", 'symmetrical': 'False', 'db_table': "'agr_accepted_monkeys_to_blood_and_genetic_requests'", 'to': "orm['matrr.Monkey']"}),
