...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResearchUpdate'
        db.create_table('rud_research_update', (
            ('rud_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rud_set', db_column='req_id', to=orm['matrr.Request'])),
            ('rud_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('rud_title', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('rud_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100)),
        ))
        db.send_create_signal('matrr', ['ResearchUpdate'])


    def backwards(self, orm):
        
        # Deleting model 'ResearchUpdate'
        db.delete_table('rud_research_update')
    ...
    models = {
        ...
        'matrr.researchupdate': {
            ...
            'rud_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
