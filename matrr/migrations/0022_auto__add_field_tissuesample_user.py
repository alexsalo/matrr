...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TissueSample.user'
        db.add_column('tss_tissue_samples', 'user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, db_column='usr_usr_id', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TissueSample.user'
        db.delete_column('tss_tissue_samples', 'usr_usr_id')
    ...
    models = {
        ...
        'matrr.tissuesample': {
            ...
            'tss_sample_quantity': ('django.db.models.fields.FloatField', [], {'default': '1', 'null': 'True'}),
