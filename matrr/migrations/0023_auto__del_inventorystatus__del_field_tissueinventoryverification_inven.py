...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TissueInventoryVerification.inventory'
        db.delete_column('tiv_tissue_verification', 'inv_id')

        # Adding field 'TissueInventoryVerification.tiv_inventory'
        db.add_column('tiv_tissue_verification', 'tiv_inventory', self.gf('django.db.models.fields.CharField')(default=('Unverified', 'Unverified'), max_length=100), keep_default=False)

        # Changing field 'MonkeyToDrinkingExperiment.mtd_veh_intake'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_veh_intake', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'MonkeyToDrinkingExperiment.mtd_etoh_intake'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_intake', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'MonkeyToDrinkingExperiment.mtd_total_pellets'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_total_pellets', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    def backwards(self, orm):
        ...
        db.create_table('inv_inventory_status', (
            ('inv_status', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True)),
            ('inv_description', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
            ('inv_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('matrr', ['InventoryStatus'])

        # Adding field 'TissueInventoryVerification.inventory'
        db.add_column('tiv_tissue_verification', 'inventory', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['matrr.InventoryStatus'], db_column='inv_id'), keep_default=False)

        # Deleting field 'TissueInventoryVerification.tiv_inventory'
        db.delete_column('tiv_tissue_verification', 'tiv_inventory')
        ...
        # Changing field 'MonkeyToDrinkingExperiment.mtd_total_pellets'
        db.alter_column('mtd_monkeys_to_drinking_experiments', 'mtd_total_pellets', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'matrr.tissueinventoryverification': {
            ...
            'tiv_inventory': ('django.db.models.fields.CharField', [], {'default': "('Unverified', 'Unverified')", 'max_length': '100'}),
