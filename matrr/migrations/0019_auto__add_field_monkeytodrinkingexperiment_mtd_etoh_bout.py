...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MonkeyToDrinkingExperiment.mtd_etoh_bout'
        db.add_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_bout', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MonkeyToDrinkingExperiment.mtd_etoh_bout'
        db.delete_column('mtd_monkeys_to_drinking_experiments', 'mtd_etoh_bout')
