...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TissueVerification'
        db.create_table('tvm_tissue_verification', (
            ('tvm_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('tissue_sample', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tissue_verification_set', db_column='tss_id', to=orm['matrr.TissueSample'])),
            ('tvm_notes', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('tvm_verified', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('tvm_date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('tvm_date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('matrr', ['TissueVerification'])
        ...
        # Adding field 'TissueSample.tss_sample_units'
        db.add_column('tss_tissue_samples', 'tss_sample_units', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['matrr.Unit']), keep_default=False)
        ...
        db.alter_column('tst_tissue_types', 'tst_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5))


    def backwards(self, orm):
        
        # Deleting model 'TissueVerification'
        db.delete_table('tvm_tissue_verification')
        ...
        # Adding field 'TissueSample.tss_sample_count'
        db.add_column('tss_tissue_samples', 'tss_sample_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'TissueSample.tss_sample_quantity'
        db.delete_column('tss_tissue_samples', 'tss_sample_quantity')

        # Deleting field 'TissueSample.tss_sample_units'
        db.delete_column('tss_tissue_samples', 'tss_sample_units_id')
    ...
    models = {
        ...
        'matrr.tissuesample': {
            ...
            'tss_sample_units': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['matrr.Unit']"})
        },
        'matrr.tissuetype': {
            ...
            'tst_cost': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '10', 'decimal_places': '5'}),
        ...
        'matrr.tissueverification': {
            'Meta': {'object_name': 'TissueVerification', 'db_table': "'tvm_tissue_verification'"},
            ...
            'tissue_sample': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tissue_verification_set'", 'db_column': "'tss_id'", 'to': "orm['matrr.TissueSample']"}),
            'tvm_date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'tvm_date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'tvm_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tvm_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'tvm_verified': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'})
        },
        'matrr.unit': {
