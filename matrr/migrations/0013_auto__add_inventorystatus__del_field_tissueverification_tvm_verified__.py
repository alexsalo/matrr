...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TissueVerification.tvm_verified'
        db.delete_column('tvm_tissue_verification', 'tvm_verified')

        # Adding field 'TissueVerification.inventory'
        db.add_column('tvm_tissue_verification', 'inventory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matrr.InventoryStatus'], null=True, db_column='inv_id'), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TissueVerification.tvm_verified'
        db.add_column('tvm_tissue_verification', 'tvm_verified', self.gf('django.db.models.fields.CharField')(default='Unverified', max_length=12, null=True), keep_default=False)

        # Deleting field 'TissueVerification.inventory'
        db.delete_column('tvm_tissue_verification', 'inv_id')
    ...
    models = {
        ...
        'matrr.tissuesample': {
            ...
            'units': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['matrr.Unit']"})
        },
        'matrr.tissuetype': {
        ...
        'matrr.tissueverification': {
            ...
            'inventory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['matrr.InventoryStatus']", 'null': 'True', 'db_column': "'inv_id'"}),
