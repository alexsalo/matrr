...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CohortData'
        db.create_table('cod_cohort_datafile', (
            ('cod_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cohort', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cod_set', db_column='coh_cohort_id', to=orm['matrr.Cohort'])),
            ('cod_title', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('cod_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100)),
        ))
        db.send_create_signal('matrr', ['CohortData'])

        # Changing field 'ResearchUpdate.rud_date'
        db.alter_column('rud_research_update', 'rud_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))


    def backwards(self, orm):
        
        # Deleting model 'CohortData'
        db.delete_table('cod_cohort_datafile')

        # Changing field 'ResearchUpdate.rud_date'
        db.alter_column('rud_research_update', 'rud_date', self.gf('django.db.models.fields.DateField')(null=True))
