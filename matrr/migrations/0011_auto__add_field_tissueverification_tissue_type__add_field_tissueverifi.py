...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TissueVerification.tissue_type'
        db.add_column('tvm_tissue_verification', 'tissue_type', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='tissue_verification_set', db_column='tst_type_id', to=orm['matrr.TissueType']), keep_default=False)

        # Adding field 'TissueVerification.monkey'
        db.add_column('tvm_tissue_verification', 'monkey', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='tissue_verification_set', db_column='mky_id', to=orm['matrr.Monkey']), keep_default=False)

        # Changing field 'TissueVerification.tvm_verified'
        db.alter_column('tvm_tissue_verification', 'tvm_verified', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'TissueVerification.tissue_sample'
        db.alter_column('tvm_tissue_verification', 'tss_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column='tss_id', to=orm['matrr.TissueSample']))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TissueVerification.tissue_type'
        db.delete_column('tvm_tissue_verification', 'tst_type_id')

        # Deleting field 'TissueVerification.monkey'
        db.delete_column('tvm_tissue_verification', 'mky_id')

        # Changing field 'TissueVerification.tvm_verified'
        db.alter_column('tvm_tissue_verification', 'tvm_verified', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TissueVerification.tissue_sample'
        db.alter_column('tvm_tissue_verification', 'tss_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, db_column='tss_id', to=orm['matrr.TissueSample']))
    ...
    models = {
        ...
        'matrr.tissueverification': {
            ...
            'tvm_verified': ('django.db.models.fields.CharField', [], {'default': "'Unverified'", 'max_length': '12', 'null': 'True'})
        },
        'matrr.unit': {
