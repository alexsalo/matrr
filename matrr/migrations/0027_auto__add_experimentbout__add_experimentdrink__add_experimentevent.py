...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExperimentBout'
        db.create_table('ebt_experiment_bouts', (
            ('ebt_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mtd', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bouts_set', db_column='mtd_id', to=orm['matrr.MonkeyToDrinkingExperiment'])),
            ('ebt_number', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('ebt_start_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('ebt_end_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('ebt_length', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('ebt_ibi', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('ebt_volume', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('matrr', ['ExperimentBout'])

        # Adding model 'ExperimentDrink'
        db.create_table('edr_experiment_drinks', (
            ('edr_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ebt', self.gf('django.db.models.fields.related.ForeignKey')(related_name='drinks_set', db_column='ebt_id', to=orm['matrr.ExperimentBout'])),
            ('edr_number', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('edr_start_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('edr_end_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('edr_length', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('edr_ibi', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('edr_volume', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('matrr', ['ExperimentDrink'])

        # Adding model 'ExperimentEvent'
        db.create_table('eev_experiment_events', (
            ('eev_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mtd', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events_set', db_column='mtd_id', to=orm['matrr.MonkeyToDrinkingExperiment'])),
            ('eev_occurred', self.gf('django.db.models.fields.DateTimeField')()),
            ('eev_dose', self.gf('django.db.models.fields.FloatField')()),
            ('eev_fixed_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('eev_experiment_state', self.gf('django.db.models.fields.IntegerField')()),
            ('eev_event_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('eev_session_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('eev_segement_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('eev_pellet_time', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('eev_etoh_side', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('eev_etoh_volume', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('eev_etoh_total', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('eev_etoh_elapsed_time_since_last', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('eev_veh_side', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('eev_veh_volume', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('eev_veh_total', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('eev_veh_elapsed_time_since_last', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('eev_scale_string', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('eev_hand_in_bar', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('eev_blank', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('eev_etoh_bout_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('eev_etoh_drink_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('eev_veh_bout_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('eev_veh_drink_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('eev_timing_comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('matrr', ['ExperimentEvent'])


    def backwards(self, orm):
        
        # Deleting model 'ExperimentBout'
        db.delete_table('ebt_experiment_bouts')

        # Deleting model 'ExperimentDrink'
        db.delete_table('edr_experiment_drinks')

        # Deleting model 'ExperimentEvent'
        db.delete_table('eev_experiment_events')
    ...
    models = {
        ...
        'matrr.cohortimage': {
            'Meta': {'object_name': 'CohortImage', 'db_table': "'cig_cohort_image'"},
            'cig_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'cohort': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'image_set'", 'to': "orm['matrr.Cohort']"}),
            ...
            'parameters': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
        ...
        'matrr.experimentdrink': {
            ...
            'edr_ibi': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
