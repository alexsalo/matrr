...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TissueInventoryVerification.tvm_date_modified'
        db.delete_column('tvm_tissue_verification', 'tvm_date_modified')

        # Deleting field 'TissueInventoryVerification.tvm_date_created'
        db.delete_column('tvm_tissue_verification', 'tvm_date_created')

        # Adding field 'TissueInventoryVerification.tiv_date_modified'
        db.add_column('tiv_tissue_verification', 'tiv_date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 9, 7), blank=True), keep_default=False)

        # Adding field 'TissueInventoryVerification.tiv_date_created'
        db.add_column('tiv_tissue_verification', 'tiv_date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 9, 7), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'TissueInventoryVerification.tvm_date_modified'
        db.add_column('tvm_tissue_verification', 'tvm_date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 9, 7), blank=True), keep_default=False)

        # Adding field 'TissueInventoryVerification.tvm_date_created'
        db.add_column('tvm_tissue_verification', 'tvm_date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 9, 7), blank=True), keep_default=False)

        # Deleting field 'TissueInventoryVerification.tiv_date_modified'
        db.delete_column('tiv_tissue_verification', 'tiv_date_modified')

        # Deleting field 'TissueInventoryVerification.tiv_date_created'
        db.delete_column('tiv_tissue_verification', 'tiv_date_created')
