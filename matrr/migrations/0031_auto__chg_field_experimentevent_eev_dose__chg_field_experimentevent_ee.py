...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExperimentEvent.eev_dose'
        db.alter_column('eev_experiment_events', 'eev_dose', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ExperimentEvent.eev_pellet_time'
        db.alter_column('eev_experiment_events', 'eev_pellet_time', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'ExperimentEvent.eev_segement_time'
        db.alter_column('eev_experiment_events', 'eev_segement_time', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'ExperimentEvent.eev_session_time'
        db.alter_column('eev_experiment_events', 'eev_session_time', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'ExperimentEvent.eev_panel'
        db.alter_column('eev_experiment_events', 'eev_panel', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'ExperimentEvent.eev_fixed_time'
        db.alter_column('eev_experiment_events', 'eev_fixed_time', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'ExperimentEvent.eev_dose'
        db.alter_column('eev_experiment_events', 'eev_dose', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'ExperimentEvent.eev_pellet_time'
        db.alter_column('eev_experiment_events', 'eev_pellet_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'ExperimentEvent.eev_segement_time'
        db.alter_column('eev_experiment_events', 'eev_segement_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'ExperimentEvent.eev_session_time'
        db.alter_column('eev_experiment_events', 'eev_session_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'ExperimentEvent.eev_panel'
        db.alter_column('eev_experiment_events', 'eev_panel', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'ExperimentEvent.eev_fixed_time'
        db.alter_column('eev_experiment_events', 'eev_fixed_time', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    ...
    models = {
        ...
        'matrr.experimentevent': {
            ...
            'eev_dose': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            ...
            'eev_fixed_time': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            ...
            'eev_panel': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'eev_pellet_time': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'eev_scale_string': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'eev_segement_time': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'eev_session_time': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'eev_source_row_number': ('django.db.models.fields.PositiveIntegerField', [], {}),
