...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('mky_monkeys', 'mky_birthdate_date', 'mky_birthdate')
        # Deleting field 'Monkey.mky_birthdate_date'
        #db.delete_column('mky_monkeys', )

        # Adding field 'Monkey.mky_birthdate'
        #db.add_column('mky_monkeys', 'mky_birthdate', self.gf('django.db.models.fields.DateField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        db.rename_column('mky_monkeys', 'mky_birthdate', 'mky_birthdate_date')
        
        # Adding field 'Monkey.mky_birthdate_date'
#        db.add_column('mky_monkeys', 'mky_birthdate_date', self.gf('django.db.models.fields.DateField')(max_length=20, null=True, blank=True), keep_default=False)
#
