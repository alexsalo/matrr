...
RHESUS_DRINKERS_DISTINCT['LD'] = [10048, 10052, 10055, 10056, 10058, 10083, 10084, 10085, 10089, 10090, 10092, 10072, 10074, 10077]
...
RHESUS_DRINKERS_DISTINCT['VHD'] = [10088, 10091, 10066, 10098, 10063, 10061, 10062, 10073, 10075]

# before cohort_pk=8 inclusion
#RHESUS_DRINKERS_DISTINCT = dict()
