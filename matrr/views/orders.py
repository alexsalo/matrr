...
@user_owner_test(lambda u, req_id: u == Request.objects.get(req_request_id=req_id).user or u.has_perm('matrr.handle_shipments') or  u.has_perm('matrr.process_shipments'), arg_name='req_request_id', redirect_url='/denied/')
