...
urlpatterns += patterns('matrr.views',
  ...
  url( r'^monkeys/(?P<monkey_id>\S+)/$',
      monkey_detail_view),
  url( r'^upcoming/(?P<cohort_id>\d+)/tissues/(?P<tissue_model>regions|samples|peripherals)/$',
      tissue_list),
  url( r'^upcoming/(?P<cohort_id>\d+)/tissues/(?P<tissue_model>regions|samples|peripherals)/(?P<tissue_id>\d+)/$',
      tissue_shop_detail_view),
  url( r'^cart/(?P<tissue_model>regions|samples|peripherals)/(?P<tissue_request_id>\d+)/$',
    cart_item_view),
  url( r'^cart/(?P<tissue_model>regions|samples|peripherals)/(?P<tissue_request_id>\d+)/delete/$',
      cart_item_delete),
